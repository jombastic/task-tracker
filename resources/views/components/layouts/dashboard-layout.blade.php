    ...
    <div class="flex min-h-screen flex-col md:flex-row">
        ...
        <header class="flex items-center justify-between border-b bg-white px-4 py-3 md:hidden">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button id="mobile-menu-button" aria-label="Open menu" class="text-gray-600 focus:outline-none">
        ...
        <aside id="sidebar"
            ...
            <nav class="space-y-2 px-4">
                <a href="{{ route('dashboard.index') }}" class="block rounded px-3 py-2 hover:bg-gray-100">
                    Dashboard
                </a>
        ...
        <div id="sidebar-overlay" class="bg-opacity-40 fixed inset-0 z-20 hidden bg-black md:hidden"></div>

        {{-- Main Area --}}
        <div class="flex min-h-screen flex-1 flex-col md:ml-0">
            {{-- Top Bar for desktop --}}
            <header class="hidden items-center justify-between border-b bg-white px-6 py-4 md:flex">
